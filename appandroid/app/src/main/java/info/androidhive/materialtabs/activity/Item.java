...
public class Item {
    ...
    public Item(String mock,String price, String pledgePrice, String fromAddress, String toAddress, String requestsCount, String date, String time) {
        this.price = price;
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("Phenix","", "15%", "Phenix", "", "50%", "TODAY", "05:10 PM"));
        items.add(new Item("Alimentaire","", "20%", "Alimentaire", "", "15%", "TODAY", "11:10 AM"));
        return items;
