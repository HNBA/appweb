...
$servers->setValue('server','host','bastion');
...
$servers->setValue('server','base',array('dc=trainees,dc=ddns,dc=net'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=trainees,dc=ddns,dc=net');
#  $servers->setValue('login','bind_id','cn=Manager,dc=example,dc=com');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
$servers->setValue('login','bind_pass','trainees');
